        ...
        <Container id={'anchor'}>
            ...
            <ColorEditorContainer>
                ...
                <Box>
                    ...
                    <StyledInput type={'color'} defaultValue={accentColor} onChange={(e) => { setAccentColor(e.currentTarget.value) }} css={{ padding: '1px 2px' }}></StyledInput>
                </Box>
                <Box>
                    <StyledLabel> Preview in your app <ExternalLinkIcon /></StyledLabel>

                    <Box css={{ flexDirection: 'row', width: '100%', alignItems: 'center' }}>
                        <StyledInput placeholder={'Your app url. ex.) https://davidkim.vercel.app/'} value={url} onChange={(e) => { setUrl(e.currentTarget.value) }} css={{ width: '100%' }}></StyledInput>
                        <Button size={ButtonSize.small} onClick={() => { handleIframeOpen() }}> Open </Button>
            ...
            {showIframe &&
                <Mask>
                    <Box css={{
                        ...
                        <IframeTopBar>
                            <RedButton onClick={() => { setShowIframe(!showIframe) }} />
                        </IframeTopBar>
