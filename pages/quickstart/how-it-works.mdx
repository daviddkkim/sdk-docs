...
3. You will receive a response from the above API call with the journey application Token and status of the application.
4. It's upto your application to decide how it wants to handle different `status` but typically:
...
-  for `Pending` status, you can render on your application UI a document verification form via the Alloy SDK or use your own form to collect documents.
