...
const alloyInitParams = {
    key: {your_sdk_key},
    journeyApplicationToken: {journey_application_token from api call},
    journeyToken:{journey_token from the dashboard},
    documents: ['license', 'passport'], //documents you want to collect.
    selfie: true,
};
...
<StyledLink href={'/quickstart/next-steps'}><Button size={ButtonSize.large}> Next Steps → </Button></StyledLink>
</Box>
